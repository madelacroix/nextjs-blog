...
const name = 'Mads'
export const siteTitle = 'Mads made a Next.js site'
    ...
    return (
        <div className={styles.container}>
            <Head>
                ...
                <meta name='description' content='Learn how to build website with NextNextNext'/>
            ...
            <header className='styles.header'>
                {home ? (
                    <>
                        <Image 
                        priority src='/images/profile.jpeg'
